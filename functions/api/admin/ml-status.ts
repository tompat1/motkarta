  ...
  return Response.json(
    {
      ...
      lifecycleStages: [
        ...
        { stage: "6. Online Bandit Re-ranking", completion: 30, status: "planned", notes: "Thompson sampling / contextual multi-armed bandit for real-time re-ranking." },
      ],
      gapsAndImprovements: [
        {
          id: "cold_start",
          ...
          solution: "Incorporate SentenceTransformer vector embeddings (all-MiniLM-L6-v2) on raw OSM descriptions to score potential gems.",
        },
        {
          id: "position_bias",
        ...
        },
        {
          ...
          title: "Static Batch vs Online Real-Time Feedback",
          impactScore: 45,
          category: "Online Learning",
          problem: "Scores are currently updated in batch snapshots rather than responding immediately to live user saves and route requests.",
          solution: "Implement a lightweight multi-armed bandit / contextual exploration engine in Cloudflare Workers.",
        },
      ],
