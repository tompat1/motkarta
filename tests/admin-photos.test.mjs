...
import { onRequestDelete, onRequestGet } from "../functions/api/admin/photos.ts";
  ...
  return {
    ...
    prepare(query) {
      const statement = {
        ...
        async run() { if (query.includes("DELETE FROM place_photos")) this.db.deleteValues = this.values; return { meta: { changes: 1 } }; },
        db: null,
      };
      statement.db = this;
      return statement;
