...
test("OSM normalization maps known categories to establishment types", () => {
  ...
  assert.equal(normalizeOsmEstablishmentType({ category: "restaurant", cuisine: "bistro" }), "Restaurant");
  assert.equal(normalizeOsmEstablishmentType({ category: "bistro" }), "Restaurant");
